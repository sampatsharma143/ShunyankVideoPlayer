package com.shunyank.svideoplayer.player;
...
import com.shunyank.svideoplayer.player.dtpv.DoubleTapPlayerView;
import com.shunyank.svideoplayer.player.dtpv.youtube.YouTubeOverlay;
...
import com.shunyank.svideoplayer.R;
...
public abstract class PlayerActivity extends Activity {
    ...
    public abstract View getMainLayoutResourceId();
...
//        }
    ...
    // 0 = visible 8 = gone
    protected void setFileOpenerVisibility(int visibility){
        if (visibility == View.VISIBLE)
    ...
    public void setLink(String url){
        mPrefs.updateMedia(getBaseContext(),   Uri.parse( url), "url");
    }
    ...
    void showSnack( final String textPrimary, final String textSecondary) {
        snackbar = Snackbar.make(getMainLayoutResourceId(), textPrimary, Snackbar.LENGTH_LONG);
